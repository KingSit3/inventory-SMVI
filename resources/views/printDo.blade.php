                    ...
                    <table width="100%" border="1">
                        ...
                        <tbody>
                            <tr style="font-size: 13px;">
                                ...
                                <td style="padding: 5px; vertical-align: top; text-align: left; padding-top: 5px;">MOB BENQ MX611</td>
                                <td style="padding: 5px;">
                                @foreach ($perangkat as $data)
                                    {{ $data }} &nbsp;&nbsp;
                                @endforeach
                                </td>
                                <td style="vertical-align: top; text-align: center; padding-top: 5px;">2</td>
