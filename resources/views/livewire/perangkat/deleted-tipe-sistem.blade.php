                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center items-center {{ ($loop->odd) ? "bg-red-100 bg-opacity-75" : "" }}">
                            ...
                            <td class="capitalize">{{ ($value['kode_sistem']) ? $value['kode_sistem'] : '-' }}</td>
                        ...
                        @empty
                        <tr>
                            <td class="text-center pt-5 text-red-500" colspan="4">
        ...
        <script>
            document.addEventListener('livewire:load', function () {
                @this.on('restore', id => {
                    ...
                    Swal.fire({
                    title: 'Yakin ingin mengembalikkan data ini?',
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire(
                        'Berhasil!',
                        'Tipe Sistem berhasil dikembalikkan',
                        'success'
                        )
                    }
                    })
