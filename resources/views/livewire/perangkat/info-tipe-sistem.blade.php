    ...
    <div class="px-7 py-3 flex flex-col justify-between h-screen">
        <div x-data="{infoPerangkat: false}">
            ...
            <div class="text-2xl text-center font-bold  cursor-default">
                <p class="{{ ($tipeSistem['deleted_at']) ? 'text-red-500' : 'text-blue-600' }}">Info Sistem {{ $tipeSistem['kode_sistem'] }}</p>
                ...
                <div class="flex justify-between px-5 mb-5">
                    <div class="flex flex-col font-semibold">
                        <table>
                            ...
                            <tr>
                                <td class="pr-3">Status Tipe Sistem</td>
                                <td>:</td>
                                <td class="font-semibold capitalize rounded-lg {{ ($tipeSistem['deleted_at']) ? 'text-red-500' : 'text-blue-500' }}">{{ ($tipeSistem['deleted_at']) ? 'Terhapus' : 'Aktif' }}</td>
                            </tr>
                        </table>
                    </div>
                    {{-- Search --}}
