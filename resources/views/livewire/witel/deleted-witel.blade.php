                    ...
                    {{-- Search --}}
                        <div class="flex justify-between items-center space-x-6">
                            <div class="">
                                ...
                                <input wire:model.debounce.200="keyword" class=" focus:ring-4 outline-none focus:outline-none ring-blue-300 rounded-full pl-7 py-1 duration-150" type="text" placeholder="Cari Nama Witel">
                            </div>
                        </div>
                </div>
            {{-- End Top Section --}}
                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center items-center {{ ($loop->odd) ? "bg-red-100 bg-opacity-75" : "" }}">
                            <td class="py-2">{{ ($witel->firstItem()-1) + $loop->iteration }}</td>
        ...
        <script>
            document.addEventListener('livewire:load', function () {
                @this.on('restore', id => {
                    ...
                    Swal.fire({
                    title: 'Yakin ingin mengembalikkan Witel ini?',
                    icon: 'info',
