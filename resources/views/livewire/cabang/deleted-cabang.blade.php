                    ...
                    {{-- Search --}}
                        <div class="flex justify-between items-center space-x-6">
                            <div class="">
                                ...
                                <input wire:model.debounce.200="keyword" class=" focus:ring-4 outline-none focus:outline-none ring-blue-300 rounded-full pl-7 py-1 duration-150" type="text" placeholder="Cari Nama Cabang">
                            </div>
                        </div>
                </div>
            {{-- End Top Section --}}
        ...
        <script>
            document.addEventListener('livewire:load', function () {
                @this.on('restore', id => {
                    ...
                    Swal.fire({
                    title: 'Yakin ingin mengembalikkan Cabang ini?',
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire(
                        'Berhasil!',
                        'Data Cabang berhasil dikembalikkan',
                        'success'
                        )
                    }
                    })
