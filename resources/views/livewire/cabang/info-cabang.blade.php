    ...
    <div class="px-7 py-3 flex flex-col justify-between h-screen">
        <div x-data="{infoPerangkat: false}">
            ...
            <div class="text-2xl text-center font-bold  cursor-default">
                <p class="{{ ($cabangData['deleted_at']) ? 'text-red-500' : 'text-blue-600' }}">Info Cabang {{ $cabangData['nama_cabang'] }}</p>
                    ...
                    <div class="flex flex-col font-semibold">
                        <table>
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $cabangData['users']['nama'] }}</td>
                            </tr>
                            <tr>
                                <td class="pr-3">NIK PIC</td>
                                <td>:</td>
                                <td>{{ ($cabangData['users']['nik']) ? $cabangData['users']['nik'] : '-' }}</td>
                            </tr>
                            <tr>
                                <td class="pr-3">No Telp PIC</td>
                                <td>:</td>
                                <td>{{ ($cabangData['users']['no_telp']) ? $cabangData['users']['no_telp'] : '-' }}</td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td class="font-semibold capitalize rounded-lg {{ ($cabangData['deleted_at']) ? 'text-red-500' : 'text-blue-500' }}">{{ ($cabangData['deleted_at']) ? 'Terhapus' : 'Aktif' }}</td>
                            </tr>
                        </table>
                    </div>
                    {{-- Search --}}
