    ...
    <div class="mx-2 -mt-28">
        <div class="px-6 py-6">
            <div class="text-center">
                <span class="text-xl font-semibold capitalize">Detail Log Image {{ $dataLog['image']['kode_image'] }}</span>
            </div>
            <div class="text-center my-2">
                <span class="text-xl font-semibold capitalize">Status Image:</span>
                <span class="font-semibold capitalize p-2 text-white rounded-lg {{ ($dataLog['image']['deleted_at']) ? 'text-red-500' : 'text-blue-600' }}">{{ ($dataLog['image']['deleted_at']) ? 'Terhapus' : 'Aktif' }}</span>
            </div>
            {{-- Table Content --}}
                <table width="100%" class="font-semibold mt-3">
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td width="45%">Kode Image baru</td>
                        <td width="5%">:</td>
                        <td class="bg-green-500 bg-opacity-20" width="50%">{{ $dataLog['data_log']['data_baru']['kode_image'] }}</td>
                    </tr>
        ...
        <div class="px-6 py-6">
            ...
            {{-- Table Content --}}
                <table width="100%" class="font-semibold mt-3">
                    ...
                    <tr>
                        <td width="45%">Kode Image Lama</td>
                        <td width="5%">:</td>
                        <td class="bg-red-500 bg-opacity-20" width="50%">{{ $dataLog['data_log']['data_lama']['kode_image'] }}</td>
                    </tr>
        ...
        <div class="px-6 py-6">
            ...
            {{-- Table Content --}}
                <table width="100%" class="font-semibold mt-3">
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td width="45%">Kode Image</td>
                        <td width="5%">:</td>
                        <td width="50%">{{ $dataLog['data_log']['data_lama']['kode_image'] }}</td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td width="45%">Tanggal Aksi</td>
