    ...
    <div class="mx-2 -mt-28">
        <div class="px-6 py-6">
            ...
            <div class="text-center my-2">
                ...
                <span class="font-semibold capitalize p-2 text-white rounded-lg {{ ($dataLog['tipesistem']['deleted_at']) ? 'text-red-500' : 'text-blue-600' }}">{{ ($dataLog['tipesistem']['deleted_at']) ? 'Terhapus' : 'Aktif' }}</span>
            </div>
            {{-- Table Content --}}
                <table width="100%" class="font-semibold mt-3">
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td width="45%">Kode Sistem baru</td>
                        <td width="5%">:</td>
                        <td class="bg-green-500 bg-opacity-20" width="50%">{{ $dataLog['data_log']['data_baru']['kode_sistem'] }}</td>
                    </tr>
        ...
        <div class="px-6 py-6">
            ...
            {{-- Table Content --}}
                <table width="100%" class="font-semibold mt-3">
                    ...
                    <tr>
                        <td width="45%">Kode Sistem Lama</td>
                        <td width="5%">:</td>
                        <td class="bg-red-500 bg-opacity-20" width="50%">{{ $dataLog['data_log']['data_lama']['kode_sistem'] }}</td>
                    </tr>
        ...
        <div class="px-6 py-6">
            ...
            {{-- Table Content --}}
                <table width="100%" class="font-semibold mt-3">
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td width="45%">Kode Sistem</td>
                        <td width="5%">:</td>
                        <td width="50%">{{ $dataLog['data_log']['data_lama']['kode_sistem'] }}</td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td width="45%">Tanggal Aksi</td>
