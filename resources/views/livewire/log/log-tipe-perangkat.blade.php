            ...
            <div class="flex justify-end px-5 mb-5">
                <div class="flex justify-between items-center space-x-6">
                    <div class="">
                        ...
                        <input wire:model.debounce.200="keyword" class=" focus:ring-4 outline-none focus:outline-none ring-blue-300 rounded-full pl-7 py-1 duration-150" type="text" placeholder="Cari Kode Tipe...">
                    </div>
                </div>
            </div>
            {{-- End Top Section --}}
                ...
                <table class="table-fixed w-full mt-5">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center items-center {{ ($loop->odd) ? "bg-indigo-100 bg-opacity-75" : "" }}">
                            ...
                            <td><a class="hover:text-blue-500 duration-200 font-semibold" href="/logtipeperangkat/{{ $value['id_tipe'] }}">{{ $value['TipePerangkat']['kode_perangkat']}}</a></td>
                        ...
                        @empty
                        <tr>
                            <td class="text-center pt-5 text-red-500" colspan="7">
