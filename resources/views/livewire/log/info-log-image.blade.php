    ...
    <div x-data="{detailLog: false}" class="px-7 py-3 flex flex-col justify-between h-screen">
        <div>
            ...
            <div class="text-2xl text-center font-bold  cursor-default">
                <p class="{{ ($logImage['deleted_at']) ? 'text-red-500' : 'text-blue-600' }}">Info Log Image {{ $logImage['kode_image'] }}</p>
            </div>
            ...
            {{-- Top Section --}}
                <div class="flex justify-start px-5 mb-5">
                    <div class="flex flex-col font-semibold">
                        <table>
                            <tr>
                                <td class="pr-3">Kode Image</td>
                                <td>:</td>
                                <td>{{ $logData['kode_image'] }}</td>
                            </tr>
                            <tr>
