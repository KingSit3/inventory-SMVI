        ...
        <table class="table-auto w-full">
            ...
            <tbody>
                ...
                <tr class="text-center items-center">
                    ...
                    <td>{{ $user['name'] }}</td>
                    <td>{{ $user['no_telp'] }}</td>
                    <td class="space-x-5 pb-2 pt-2">
                        <button class="bg-yellow-500 hover:bg-yellow-600 px-3 py-2 rounded-xl text-white font-semibold duration-150">
                        ...
                        <button class="bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded-xl text-white font-semibold duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-5" viewBox="0 0 24 24" stroke="currentColor">
